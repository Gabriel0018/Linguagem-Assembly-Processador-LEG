...
loop:  ld r0, [r1]     @ utiliza-se o R0 para guardar o valor lido da lista na memoria
       ...
       jz num_par       @  se o and de cima resultar em 0, então ele é par, indo para o num_par, que por sua vez coloca +1 no contador r3
...
num_par: 
 ...
 zzz:
    ...
    lista: .word 40,1,2,-2,9, 86, 3,10,332,-1,19,7,10,-4,2,89,-6